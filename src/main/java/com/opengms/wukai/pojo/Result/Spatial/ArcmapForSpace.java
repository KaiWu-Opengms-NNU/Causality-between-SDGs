...
public class ArcmapForSpace {
    ...
    //计算结果文件（只有在国家尺度才具有计算条件）
    private int RelatedNeutralizationGN;
    private int RelatedNeutralizationRN;
    private String ChangeFromGlobalToNational;
    private double ChangeFromGlobalToNational_Strength;
    private String ChangeFromRegionalToNational;
    private double ChangeFromRegionalToNational_Strength;

    //国家属性记录
    private String Economic;
    private String Population;
    private String GeoRegionParent;
