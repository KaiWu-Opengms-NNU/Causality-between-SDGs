...
public class SDGIndicatorTool {
    ...
    //网络图列表里面去重求和
    public List<NetRelationship> NoRepeatToAve(List<NetRelationship> relationshipList){
        ...
        for (int i=1;i<18;i++){
            for(int j=1;j<18;j++){
                ...
                if(Index!=0){
                    TempStrength=TempStrength/Index;
                }
                if(Type!=null){
    ...
    public double calculateQuantile(List<Double> sortedValues, double percentile) {
        int n = sortedValues.size();
        if (n == 0) throw new IllegalArgumentException("数据不能为空");
        ...
        return sortedValues.get(index) * (1 - fraction) + sortedValues.get(index + 1) * fraction;
    }


    //判断两个尺度上的交互作用属于什么类型(A是大尺度，B是小尺度）
    public String JudgeScaleChangeByNoRelatedNeutralization(String A,String B)
    {
        ...
        {
            //OtherChange_I
            if(A.equals("IF")&&B.equals("MI"))
            {
                result="OtherChange_I";
            }
            if(A.equals("IF")&&B.equals("SI"))
            {
                result="OtherChange_I";
            }
            if(A.equals("MF")&&B.equals("FI"))
            {
                result="OtherChange_I";
            }
            if(A.equals("MF")&&B.equals("SF"))
            {
                result="OtherChange_I";
            }
            if(A.equals("SF")&&B.equals("FI"))
            {
                result="OtherChange_I";
            }
            if(A.equals("SI")&&B.equals("MI"))
            {
                result="OtherChange_I";
            }
            //OtherChange_F
            if(A.equals("FI")&&B.equals("MF"))
            {
                result="OtherChange_F";
            }
            if(A.equals("FI")&&B.equals("SF"))
            {
                result="OtherChange_F";
            }
            if(A.equals("MI")&&B.equals("IF"))
            {
                result="OtherChange_F";
            }
            if(A.equals("MI")&&B.equals("SI"))
            {
                result="OtherChange_F";
            }
            if(A.equals("SF")&&B.equals("MF"))
            {
                result="OtherChange_F";
            }
            if(A.equals("SI")&&B.equals("IF"))
            {
                result="OtherChange_F";
            }

            //OppositeChange_F
            if(A.equals("IF")&&B.equals("FI"))
            {
                result="OppositeChange_F";
            }
            if(A.equals("IF")&&B.equals("SF"))
            {
                result="OppositeChange_F";
            }
            if(A.equals("IF")&&B.equals("MF"))
            {
                result="OppositeChange_F";
            }
            if(A.equals("MI")&&B.equals("FI"))
            {
                result="OppositeChange_F";
            }
            if(A.equals("MI")&&B.equals("SF"))
            {
                result="OppositeChange_F";
            }
            if(A.equals("MI")&&B.equals("MF"))
            {
                result="OppositeChange_F";
            }
            if(A.equals("SI")&&B.equals("FI"))
            {
                result="OppositeChange_F";
            }
            if(A.equals("SI")&&B.equals("SF"))
            {
                result="OppositeChange_F";
            }
            if(A.equals("SI")&&B.equals("MF"))
            {
                result="OppositeChange_F";
            }
            ...
            //OppositeChange_I
            if(A.equals("FI")&&B.equals("IF"))
            {
                result="OppositeChange_I";
            }
            if(A.equals("FI")&&B.equals("MI"))
            {
                result="OppositeChange_I";
            }
            if(A.equals("FI")&&B.equals("SI"))
            {
                result="OppositeChange_I";
            }
            if(A.equals("MF")&&B.equals("IF"))
            {
                result="OppositeChange_I";
            }
            if(A.equals("MF")&&B.equals("MI"))
            {
                result="OppositeChange_I";
            }
            if(A.equals("MF")&&B.equals("SI"))
            {
                result="OppositeChange_I";
            }
            if(A.equals("SF")&&B.equals("IF"))
            {
                result="OppositeChange_I";
            }
            if(A.equals("SF")&&B.equals("MI"))
            {
                result="OppositeChange_I";
            }
            if(A.equals("SF")&&B.equals("SI"))
            {
                result="OppositeChange_I";
            }
    ...
    public String JudgeScaleChangeByRelatedNeutralization(String A,String B)
    {
        String result="NoClass";

        if(A.equals("NE")&&B.equals("NE"))
        {
            result="NoChange";
        }

        //OtherChange_I
        if(A.equals("NE")&&B.equals("IF"))
        {
            result="OtherChange_NI";
        }
        if(A.equals("NE")&&B.equals("MI"))
        {
            result="OtherChange_NI";
        }
        if(A.equals("NE")&&B.equals("SI"))
        {
            result="OtherChange_NI";
        }
        if(A.equals("FI")&&B.equals("NE"))
        {
            result="OtherChange_FN";
        }
        if(A.equals("SF")&&B.equals("NE"))
        {
            result="OtherChange_FN";
        }
        if(A.equals("MF")&&B.equals("NE"))
        {
            result="OtherChange_FN";
        }

        //OtherChange_F
        if(A.equals("NE")&&B.equals("FI"))
        {
            result="OtherChange_NF";
        }
        if(A.equals("NE")&&B.equals("MF"))
        {
            result="OtherChange_NF";
        }
        if(A.equals("NE")&&B.equals("SF"))
        {
            result="OtherChange_NF";
        }
        if(A.equals("IF")&&B.equals("NE"))
        {
            result="OtherChange_IN";
        }
        if(A.equals("MI")&&B.equals("NE"))
        {
            result="OtherChange_IN";
        }
        if(A.equals("SI")&&B.equals("NE"))
        {
            result="OtherChange_IN";
        }
        return result;
